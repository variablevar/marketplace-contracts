...
export interface NFTMarketplaceBlueprintInterface extends Interface {
    getFunction(nameOrSignature: "auctionNfts" | "bidPrices" | "listNfts" | "offerNfts" | "owner" | "renounceOwnership" | "transferOwnership"): FunctionFragment;
...
export interface NFTMarketplaceBlueprint extends BaseContract {
    connect(runner?: ContractRunner | null): NFTMarketplaceBlueprint;
    waitForDeployment(): Promise<this>;
    interface: NFTMarketplaceBlueprintInterface;
