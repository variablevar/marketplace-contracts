...
export interface NFTInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "balanceOf" | "getApproved" | "getRoyaltyFee" | "getRoyaltyRecipient" | "isApprovedForAll" | "name" | "owner" | "ownerOf" | "renounceOwnership" | "safeMint" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom" | "transferOwnership" | "updateRoyaltyFee"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "getRoyaltyFee", values?: undefined): string;
    encodeFunctionData(functionFragment: "getRoyaltyRecipient", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "updateRoyaltyFee", values: [BigNumberish]): string;
    decodeFunctionResult(functionFragment: "approve", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "balanceOf", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getApproved", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getRoyaltyFee", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getRoyaltyRecipient", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "updateRoyaltyFee", data: BytesLike): Result;
}
...
export interface NFT extends BaseContract {
    ...
    getRoyaltyRecipient: TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "getRoyaltyFee"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "getRoyaltyRecipient"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "safeMint"): TypedContractMethod<[to: AddressLike, uri: string], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "updateRoyaltyFee"): TypedContractMethod<[_royaltyFee: BigNumberish], [void], "nonpayable">;
